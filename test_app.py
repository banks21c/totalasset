...
check("A값이 2026년 기준", "const A_VALUE=3193511" in calc)
check("옛 2024년 A값 제거됨", "2989237" not in calc)
check("A값 기준연도 표기", "A_VALUE_YEAR='2026'" in calc)
check("주의문에 A값 연도 명시", "2026년 A값 3,193,511원" in calc)
